    ...
    return (
        ...
        <Row>
            ...
            <h3 className='mt-5'>Sinopsis</h3>
                <hr />
                Film ini dibuka dengan adegan para Avengers menyerang markas Hydra yang dipimpin oleh Baron Wolfgang von Strucker. Target utama mereka adalah merebut tongkat Loki yang digunakan Hydra untuk bereksperimen membentuk manusia super.
            </Col>
        </Row>
        </Container>
        </Container>
